...
event.value = util.printf("%.3f" , Avg('AverageSSDBulkPerSite1' , 'AverageSSDBulkPerSite2' , 'AverageSSDBulkPerSite3'));
//</ACRO_script>
//</AcroForm>

//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite1:Validate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite1:Validate ***********/
// Blank the field if it calculates to zero
if (+event.value === 0) event.value = ""; 
//</ACRO_script>
//</AcroForm>
...
//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite1:Calculate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite1:Calculate ***********/
...
//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite2:Validate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite2:Validate ***********/
// Blank the field if it calculates to zero
if (+event.value === 0) event.value = ""; 
//</ACRO_script>
//</AcroForm>
...
//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite2:Calculate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite2:Calculate ***********/
...
//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite3:Validate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite3:Validate ***********/
// Blank the field if it calculates to zero
if (+event.value === 0) event.value = ""; 
//</ACRO_script>
//</AcroForm>
...
//<AcroForm>
//<ACRO_source>AverageSSDBulkPerSite3:Calculate</ACRO_source>
//<ACRO_script>
/*********** belongs to: AcroForm:AverageSSDBulkPerSite3:Calculate ***********/
...
event.value = util.printf("%.1f" , Avg('TargetTestSiteNuclearfromTL581' , 'TargetTestSiteNuclearfromTL582' , 'TargetTestSiteNuclearfromTL583' , 'TargetTestSiteNuclearfromTL584' , 'TargetTestSiteNuclearfromTL585' , 'TargetTestSiteNuclearfromTL586' , 'TargetTestSiteNuclearfromTL587' , 'TargetTestSiteNuclearfromTL588' , 'TargetTestSiteNuclearfromTL589' , 'TargetTestSiteNuclearfromTL5810'));
