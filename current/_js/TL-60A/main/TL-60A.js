...
event.value = util.printf("%.3f" , Avg('SSDBulkSpecificGravityAF1' , 'SSDBulkSpecificGravityAF2' , 'SSDBulkSpecificGravityAF3' , 'SSDBulkSpecificGravityAF4' , 'SSDBulkSpecificGravityAF5' , 'SSDBulkSpecificGravityAF6' , 'SSDBulkSpecificGravityAF7'));
//</ACRO_script>
//</AcroForm>
...
var patternEmpty = /^\s*$/;
  var strMissing = "";
  if(patternEmpty.test(this.getField("trialSectionNumber").value))
     strMissing = "Trial Section Number";
...
else if(patternEmpty.test(this.getField("scaleModel").value))
     strMissing = "Scale Model";
else if(patternEmpty.test(this.getField("serialNumber").value))
     strMissing = "Serial Number";
